...
/* Code goes below */
const pokemonObject = fetchPokemonData();
//console.log('pokemonObject', pokemonObject);

const imageWrapper = document.getElementById('images');

for (const key in pokemonObject.sprites) {
    if (pokemonObject.sprites[key]) {
        const img = document.createElement('img');
        img.src = pokemonObject.sprites[key];

        //console.log(pokemonObject.sprites[key]);
