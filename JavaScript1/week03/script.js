...
console.log(x == y); //false    because they are two different arrays
console.log(x === y); //false   because they are two different arrays
console.log(z == y); //true     because they are the same array
console.log(z == x); //false    because they are two different arrays
